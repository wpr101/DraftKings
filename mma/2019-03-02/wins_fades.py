...
fighters = []
fighters.append(Player('Jones', -902, 9600, 1, 107.5))
fighters.append(Player('Smith', 582, 6600, 1, 18))
fighters.append(Player('Woodley', -168, 8700, 2, 17)) 
fighters.append(Player('Usman', 140, 7500, 2, 131.5))
fighters.append(Player('Askren', -274, 9000, 3, 95))
fighters.append(Player('Lawler', 220, 7200, 3, 21))
fighters.append(Player('Zhang', -140, 8300, 4, 88.5))
fighters.append(Player('Torres', 116, 7900, 4, 15))
fighters.append(Player('Garbrandt', -153, 8500, 5, 10.5))
fighters.append(Player('Munhoz', 126, 7700, 5, 115.5))
fighters.append(Player('Zabit', -255, 8900, 6, 92))
fighters.append(Player('Stephens', 204, 7300, 6, 20.5))
fighters.append(Player('Walker', -152, 8400, 7, 102))
fighters.append(Player('Cirkunov', 125, 7800, 7, 0.5))
fighters.append(Player('Stamann', -202, 8600, 8, 54))
fighters.append(Player('Perez', 166, 7600, 8, 25.5))
fighters.append(Player('Gall', -230, 9100, 9, 11.5))
fighters.append(Player('Sanchez', 185, 7100, 9, 133))
fighters.append(Player('Shahbazyan', -142, 8200, 10, 106.5))
fighters.append(Player('Byrd', 115, 8000, 10, 0.5))
fighters.append(Player('Chiasson', -502, 9400, 11, 112.5))
fighters.append(Player('Mazany', 374, 6800, 11, 7))
#fighters.append(Player('Vera', -214, 8800, 12, 0))
#fighters.append(Player('Saenz', 172, 7400, 12, 0))
fighters.append(Player('Viana', -269, 9200, 13, 38.5))
fighters.append(Player('Cifers', 215, 7000, 13, 73.5))

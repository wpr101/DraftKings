...
fighters = []
fighters.append(Player('Santos', -126, 8500, 1, 89))
fighters.append(Player('Blachowicz', 102, 7700, 1, 0))
fighters.append(Player('Lima', -107, 8400, 2, 0)) 
fighters.append(Player('Struve', -115, 7800, 2, 81))
fighters.append(Player('Oleksiejczuk', -214, 8900, 3, 0))
fighters.append(Player('Villante', 176, 7300, 3, 0))
fighters.append(Player('Carmouche', -157, 8300, 4, 0))
fighters.append(Player('Pudilova', 129, 7900, 4, 0))
fighters.append(Player('Yan', -275, 9300, 5, 0))
fighters.append(Player('Dodson', 218, 6900, 5, 0))
fighters.append(Player('Ankalaev', -219, 9100, 6, 0))
fighters.append(Player('Abreu', 175, 7100, 6, 0))
fighters.append(Player('PedersoliJr', -159, 8200, 7, 0))
fighters.append(Player('Grant', 132, 8000, 7, 110))
fighters.append(Player('Fishgold', -245, 9000, 8, 117))
fighters.append(Player('Teymur', 196, 7200, 8, 0))
fighters.append(Player('Robertson', -175, 8600, 9, 118.5))
fighters.append(Player('Macedo', 145, 7600, 9, 0))
fighters.append(Player('Reyes', 108, 8800, 10, 0))
fighters.append(Player('Hadzovic', -133, 7400, 10, 118))
fighters.append(Player('Prazeres', -150, 9400, 11, 0))
fighters.append(Player('Naurdiev', 570, 6800, 11, 0))
fighters.append(Player('Khabilov', -137, 8700, 12, 0))
fighters.append(Player('Ferreira', 112, 7500, 12, 0))
fighters.append(Player('Ismagulov', -320, 9200, 13, 0))
fighters.append(Player('Alvarez', 250, 7000, 13, 0))
